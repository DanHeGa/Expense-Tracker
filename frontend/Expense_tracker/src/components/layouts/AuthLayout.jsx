  ...
  return (
    <div className='flex'>
        ...
        <div className='hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative'>
            ...
            <div className='w-48 h-56 rounded-[40px] bg-violet-400 absolute -bottom-7 -left-10' />
            
            <div className='grid grid-cols-1 z-20'>
                <StatsInfoCard 
                    icon={<LuTrendingUpDown />}
                    label="Keep track of your finances"
                    value="430,000"
                    color="bg-primary"
                />
            </div>
            ...
            <img 
                src={expenses}
                className='w-64 lg:w-[70%] absolute bottom-10 align-middle left-1/2 transform -translate-x-1/2'
            />
